...
public abstract class MHNNotationControl extends NotationControl {
  protected static final String[] builtinHandsNames = {"inside", "outside", "half", "Mills"};
  protected static final String[] builtinHandsStrings = {
    "(10)(32.5).", "(32.5)(10).", "(32.5)(10).(10)(32.5).", "(-25)(2.5).(25)(-2.5).(-25)(0)."
  };

  protected static final String[] builtinBodyNames = {
    "line", "feed", "backtoback", "sidetoside", "circles"
  };
  ...
  public void resetControl() {
    ...
    tf2.setText(JLFunc.jlToStringRounded(MHNPattern.DWELL_DEFAULT, 2)); // dwell beats
  ...
  public ParameterList getParameterList() throws JuggleExceptionUser {
    ...
    if (!tf2.getText().isEmpty()) {
      if (!tf2.getText().equals(JLFunc.jlToStringRounded(MHNPattern.DWELL_DEFAULT, 2))) {
        sb.append(";dwell=");
