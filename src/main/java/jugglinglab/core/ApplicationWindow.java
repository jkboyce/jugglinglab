...
public class ApplicationWindow extends JFrame implements ActionListener {
  ...
  public static void openJMLFile(File jmlf) throws JuggleExceptionUser, JuggleExceptionInternal {
    try {
      ...
      throw new JuggleExceptionUser(
          errorstrings.getString("Error_file_not_found") + ": " + fnfe.getMessage());
  ...
  public static void showAboutBox() {
    ...
    gb.setConstraints(
        abouttext6,
        JLFunc.constraints(GridBagConstraints.LINE_START, 0, 2, new Insets(15, 15, 15, 15)));
    ...
    gb.setConstraints(
        abouttext3,
        JLFunc.constraints(GridBagConstraints.LINE_START, 0, 3, new Insets(0, 15, 15, 15)));
  ...
  protected static final String[] fileItems = {
    "New Pattern", "New Pattern List", "Open JML...", null, "Quit",
  };
  protected static final String[] fileCommands = {
    "newpat", "newpl", "open", null, "exit",
  };
