...
public class PatternListPanel extends JPanel {
  ...
  static final DataFlavor PATTERN_FLAVOR =
      new DataFlavor(PatternRecord.class, "Juggling Lab pattern record");
  ...
  protected static final String[] popupCommands = {
    "inserttext", null, "insertpattern", null, "title", "displaytext", null, "remove",
  };
      ...
      try {
        ...
        if (t.isDataFlavorSupported(DataFlavor.stringFlavor)) {
          ...
          for (int i = lines.length - 1; i >= 0; --i) {
            PatternRecord rec = new PatternRecord(lines[i], null, null, null, null, null, null);
  ...
  class PatternTransferable implements Transferable {
    ...
    public DataFlavor[] getTransferDataFlavors() {
      return new DataFlavor[] {
        PATTERN_FLAVOR, DataFlavor.stringFlavor,
      };
    }
