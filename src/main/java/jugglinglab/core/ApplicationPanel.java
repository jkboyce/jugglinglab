...
public class ApplicationPanel extends JPanel implements ActionListener {
  ...
  protected void addTransitionerControl(Transitioner trans, PatternListPanel plp) {
    ...
    trans_button.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent ae) {
            Thread t =
                  ...
                  public void run() {
                    ...
                    try {
                      ...
                      if (plp != null) {
                        ...
                        String title =
                            trans.getNotationName() + " " + guistrings.getString("Patterns");
                      ...
                      new LabelDialog(
                          parent, guistrings.getString("Generator_stopped_title"), ex.getMessage());
  ...
  protected void addGeneratorControl(Generator gen, PatternListPanel plp) {
                  ...
                  public void run() {
                    ...
                    try {
                      ...
                      if (plp != null) {
                        ...
                        String title =
                            gen.getNotationName() + " " + guistrings.getString("Patterns");
                        pw = new PatternListWindow(title, this);
                        pwot = new GeneratorTarget(pw.getPatternListPanel());
                      }
    ...
    p4.add(gen_busy);
    gb.setConstraints(
        gen_busy, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 0, new Insets(0, 10, 0, 0)));
