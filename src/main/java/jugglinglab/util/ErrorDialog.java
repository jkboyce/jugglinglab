...
public class ErrorDialog {
  ...
  private static void showInternalErrorWindow(Exception e) {
    ...
    exp.add(text1);
    gb.setConstraints(
        text1, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 0, new Insets(10, 10, 0, 10)));

    JLabel text2 = new JLabel(exmsg2);
    text2.setFont(new Font("SansSerif", Font.PLAIN, 12));
    exp.add(text2);
    gb.setConstraints(
        text2, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 1, new Insets(10, 10, 0, 10)));

    JLabel text3 = new JLabel(exmsg3);
    text3.setFont(new Font("SansSerif", Font.PLAIN, 12));
    exp.add(text3);
    gb.setConstraints(
        text3, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 2, new Insets(0, 10, 0, 10)));

    JLabel text4 = new JLabel(exmsg4);
    text4.setFont(new Font("SansSerif", Font.PLAIN, 12));
    exp.add(text4);
    gb.setConstraints(
        text4, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 3, new Insets(0, 10, 0, 10)));

    JLabel text5 = new JLabel(exmsg5);
    text5.setFont(new Font("SansSerif", Font.BOLD, 12));
    exp.add(text5);
    gb.setConstraints(
        text5, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 4, new Insets(10, 10, 10, 10)));
    ...
    exp.add(jsp);
    gb.setConstraints(
        jsp, JLFunc.constraints(GridBagConstraints.CENTER, 0, 5, new Insets(10, 10, 10, 10)));
    ...
    exp.add(butp);
    gb.setConstraints(
        butp, JLFunc.constraints(GridBagConstraints.LINE_END, 0, 6, new Insets(10, 10, 10, 10)));
