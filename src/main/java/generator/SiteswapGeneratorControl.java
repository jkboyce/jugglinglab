...
class SiteswapGeneratorControl extends JPanel {
    ...
    public SiteswapGeneratorControl() {
        ...
        p2.add(lab6);
        gb.setConstraints(lab6, JLFunc.constraints(GridBagConstraints.LINE_END, 0, 0,
                                                new Insets(0, 0, 0, 3)));
        ...
        p2.add(lab7);
        gb.setConstraints(lab7, JLFunc.constraints(GridBagConstraints.LINE_END, 2, 0,
                                                new Insets(0, 15, 0, 3)));
        ...
        p2.add(lab8);
        gb.setConstraints(lab8, JLFunc.constraints(GridBagConstraints.LINE_END, 4, 0,
                                                new Insets(0, 15, 0, 3)));
        ...
        p6.add(c1);
        gb.setConstraints(c1, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 1,
                                                new Insets(0, 10, 0, 0)));
        JLabel lab9 = new JLabel(guistrings.getString("Rhythm"));
        p6.add(lab9);
        gb.setConstraints(lab9, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 2,
                                                new Insets(8, 0, 0, 0)));
        ButtonGroup bg1 = new ButtonGroup();
        cb1 = new JRadioButton(guistrings.getString("asynch"));
        bg1.add(cb1);
        p6.add(cb1);
        gb.setConstraints(cb1, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 3,
                                                new Insets(0, 10, 0, 0)));
        cb2 = new JRadioButton(guistrings.getString("synch"));
        bg1.add(cb2);
        p6.add(cb2);
        gb.setConstraints(cb2, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 4,
                                                new Insets(0, 10, 0, 0)));
        /*
        ...
        p7.add(lab10);
        gb.setConstraints(lab10, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 0,
                                                new Insets(5, 0, 0, 0)));
        ButtonGroup bg2 = new ButtonGroup();
        cb5 = new JRadioButton(guistrings.getString("all"));
        bg2.add(cb5);
        p7.add(cb5);
        gb.setConstraints(cb5, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 1,
                                                new Insets(0, 10, 0, 0)));
        cb4 = new JRadioButton(guistrings.getString("non-obvious"));
        bg2.add(cb4);
        p7.add(cb4);
        gb.setConstraints(cb4, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 2,
                                                new Insets(0, 10, 0, 0)));
        cb6 = new JRadioButton(guistrings.getString("none_(prime_only)"));
        bg2.add(cb6);
        p7.add(cb6);
        gb.setConstraints(cb6, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 3,
                                                new Insets(0, 10, 0, 0)));
        ...
        p8.add(cb7);
        gb.setConstraints(cb7, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 1,
                                                new Insets(0, 10, 0, 0)));
        cb8 = new JCheckBox(guistrings.getString("excited_state_patterns"), null);
        p8.add(cb8);
        gb.setConstraints(cb8, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 2,
                                                new Insets(0, 10, 0, 0)));
        cb9 = new JCheckBox(guistrings.getString("transition_throws"), null);
        p8.add(cb9);
        gb.setConstraints(cb9, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 3,
                                                new Insets(0, 10, 0, 0)));
        cb10 = new JCheckBox(guistrings.getString("pattern_rotations"), null);
        p8.add(cb10);
        gb.setConstraints(cb10, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 4,
                                                new Insets(0, 10, 0, 0)));
        cb17 = new JCheckBox(guistrings.getString("juggler_permutations"), null);
        p8.add(cb17);
        gb.setConstraints(cb17, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 5,
                                                new Insets(0, 10, 0, 0)));
        cb15 = new JCheckBox(guistrings.getString("connected_patterns"), null);
        p8.add(cb15);
        gb.setConstraints(cb15, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 6,
                                                new Insets(0, 10, 0, 0)));
        cb18 = new JCheckBox(guistrings.getString("symmetric_patterns"), null);
        p8.add(cb18);
        gb.setConstraints(cb18, JLFunc.constraints(GridBagConstraints.LINE_START, 0, 7,
                                                new Insets(0, 10, 0, 0)));
        ...
        p3.add(lab13);
        gb.setConstraints(lab13, JLFunc.constraints(GridBagConstraints.LINE_END, 0, 0,
                                                new Insets(0, 0, 0, 3)));
        ...
        */
        ...
        p1.add(lab4);
        gb.setConstraints(lab4, JLFunc.constraints(GridBagConstraints.LINE_END, 0, 2,
                                                new Insets(3, 0, 0, 3)));
        tf7 = new JTextField(3);
        p1.add(tf7);
        gb.setConstraints(tf7, JLFunc.constraints(GridBagConstraints.LINE_START, 1, 2,
                                                new Insets(3, 0, 0, 0)));
        /*
