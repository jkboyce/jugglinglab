...
class SiteswapParser : SiteswapParserConstants {
    ...
    private lateinit var jj_2_rtns: Array<JJCalls>
    ...
    fun generateParseException(): ParseException {
        ...
        return ParseException(token, exptokseq, SiteswapParserConstants.tokenImage)
    }
    ...
    companion object {
        ...
        fun parsePattern(pat: String?): SiteswapTreeItem {
            val sr = StringReader(pat)
            val r: Reader = BufferedReader(sr)
            val parser = SiteswapParser(r)
            jugglers = -1
