...
class AnimationLayout(
    ...
    companion object {
        ...
        val EVENT_CONTROL_POINTS: List<DoubleArray> = listOf(
            ...
            doubleArrayOf(0.0, EVENT_YAXIS_CONTROL_CM, 0.0),
            doubleArrayOf(0.0, -EVENT_YAXIS_CONTROL_CM, 0.0),
            doubleArrayOf(0.0, EVENT_YAXIS_CONTROL_CM - 3.0, 2.0),
            doubleArrayOf(0.0, EVENT_YAXIS_CONTROL_CM - 3.0, -2.0),
            doubleArrayOf(0.0, -EVENT_YAXIS_CONTROL_CM + 3.0, 2.0),
            doubleArrayOf(0.0, -EVENT_YAXIS_CONTROL_CM + 3.0, -2.0),
        ...
        val POS_CONTROL_POINTS: List<DoubleArray> = listOf(
            ...
            doubleArrayOf(POSITION_BOX_HW_CM, -POSITION_BOX_HW_CM, 0.0),
            doubleArrayOf(0.0, 0.0, 0.0),
            doubleArrayOf(0.0, -POSITION_ANGLE_CONTROL_CM, 0.0),
            doubleArrayOf(0.0, 0.0, POSITION_ZAXIS_CONTROL_CM),
            doubleArrayOf(2.0, 0.0, POSITION_ZAXIS_CONTROL_CM - 3.0),
            doubleArrayOf(-2.0, 0.0, POSITION_ZAXIS_CONTROL_CM - 3.0),
