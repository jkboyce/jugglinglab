...
class SiteswapParserTokenManager : SiteswapParserConstants {
    /** Debug output.  */
    var debugStream: (String) -> Unit = ::println
    ...
    val nextToken: Token?
        ...
        get() {
            ...
            EOFLoop@ while (true) {
                ...
                while (curChar <= 13 && (0x2600L and (1L shl curChar)) != 0L) curChar = input_stream!!.BeginToken().code
                ...
                if (input_stream!!.readChar().code == '\u0000'.code) {
                    EOFSeen = true
