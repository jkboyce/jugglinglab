...
class UpdateChecker : Thread() {
    ...
    override fun run() {
        ...
        val runningVersion = org.jugglinglab.core.Constants.VERSION
    ...
    companion object {
        private val versionStringLine: String?
            ...
            get() {
                ...
                try {
                    val url = URI(org.jugglinglab.core.Constants.SITE_URL).toURL()
        ...
        private fun showUpdateBox(version: String?) {
            ...
            val message2 = jlGetStringResource(Res.string.gui_new_version_text2, org.jugglinglab.core.Constants.VERSION)
            ...
            yesbutton.addActionListener { _: ActionEvent? ->
                ...
                if (browseSupported) {
                    try {
                        Desktop.getDesktop().browse(URI(org.jugglinglab.core.Constants.DOWNLOAD_URL))
                    } catch (_: Exception) {
                        browseProblem = true
                    }
                }
                ...
                if (!browseSupported || browseProblem) {
                    val message = jlGetStringResource(
                        ...
                        org.jugglinglab.core.Constants.DOWNLOAD_URL
                    )
